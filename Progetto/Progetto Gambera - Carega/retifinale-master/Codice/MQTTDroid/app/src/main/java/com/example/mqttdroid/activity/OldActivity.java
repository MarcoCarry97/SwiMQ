...
public class OldActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try
        {
            ...
            Log.d("CREATE","OK");
            tools=new Tools(OldActivity.this);
            ...
            client=new MqttAndroidClient(OldActivity.this,"tcp://193.206.55.23:1883",String.valueOf(System.currentTimeMillis()));
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    map.put("email",email);
                    PubTask pub=new PubTask(client,Topic.OLD_TRAIN);
                    pub.execute(map);
                    Log.d("OLD EMAIL",email);
                    SubTask sub=new SubTask(client,OldActivity.this,Topic.OLD_TRAIN+"/"+email, new IMqttMessageListener() {
                        @Override
                        public void messageArrived(String s, MqttMessage mqttMessage) throws Exception {
                            try
                            {
                                ...
                                for(int i=0;i<array.length();i++)
                                {
                                    ...
                                    String coach=json.getString("coach");
                                    Date date =new Date(System.currentTimeMillis());//new Date(json.getLong("date"));//new Date(json.getLong("date"));
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        TrainingAdapter adapter=new TrainingAdapter(OldActivity.this,R.layout.train_item,trainList);
                                        trainings.setAdapter(adapter);
                                    }
                                });
                                Log.d("SUB","FINISH");
